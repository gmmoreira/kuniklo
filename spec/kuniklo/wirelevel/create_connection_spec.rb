...
module Kuniklo
  RSpec.describe Wirelevel::CreateConnection do
    ...
    context 'when connection is valid' do
      ...
      before do
        Container.stub('kuniklo.wirelevel.operations.create_socket', create_socket)
    ...
    context 'when errors happen' do
      ...
      before do
        Container.stub('kuniklo.wirelevel.operations.create_socket', create_socket)
        Container.stub('kuniklo.wirelevel.operations.write_protocol', write_protocol)
        Container.stub('kuniklo.wirelevel.operations.read_socket', read_socket)
        Container.stub('kuniklo.wirelevel.operations.validate_protocol', validate_protocol)
      end
